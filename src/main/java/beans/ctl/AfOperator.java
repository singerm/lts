  ...
  implements CtlFormula
{
  ...
  {
    // AF === !EG (!phi)
    this.phi = new NegationOperator(new EgOperator(new NegationOperator(phi)));
  }
  ...
  public void reduce(Lts automaton)
  {
    ...
    {
      // The equivalence of this operator was stored in phi, so a state satisfies the AF-operator if it satisfies phi
