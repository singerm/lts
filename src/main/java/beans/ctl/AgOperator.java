  ...
  implements CtlFormula
{
  ...
  {
    // AG === !EF (!phi)
    this.phi = new NegationOperator(new EfOperator(new NegationOperator(phi)));
  }
  ...
  public void reduce(Lts automaton)
  {
    ...
    {
      // The equivalence of this operator was stored in phi, so a state satisfies the AG-operator if it satisfies phi
