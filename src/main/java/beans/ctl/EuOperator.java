  ...
  implements CtlFormula
{
  ...
  public void reduce(Lts automaton)
  {
    ...
    {
      // All direct predecessors of psi-satisfying states are candidates to match the EU-operator
    ...
    while (!candidates.isEmpty())
    {
      ...
      // Candidates that have already been marked have to be skipped to avoid endless loops
