...
public class EgOperator implements CtlFormula {
	...
	public void reduce(Lts automaton) {
		...
		for (Set<State> scc : sccs) {
			// All states in such SCC directly satisfy the EG-operator and are
		...
		while (!candidates.isEmpty()) {
			...
			// Avoid marking the same state twice (Side-effect: avoids running
