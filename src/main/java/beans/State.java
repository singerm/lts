...
/**
 * Zustand eines LTS. Von einem Zustand aus können mehrere Transitionen (Zustandsübergänge) zu anderen Zuständen ausgehen. Da es sich
 * hierbei das Äquivalent zu einem DEA handelt, kann eine Transition mit dem gleichen Namen nur einmal von einem Zustand ausgehen.
 * 
 * @author Dagon
 * 
 */
